...
AmCharts.AmChart = AmCharts.Class({
    ...
    measure: function() {
        ...
        if (a) {
            ...
            f = a.style;
            a = f.width;
            f = f.height; - 1 != a.indexOf("px") && (c = AmCharts.removePx(a)); - 1 != f.indexOf("px") &&
                ...
                switch (g) {
                    ...
                    case "smoothedLine":
                        if (isNaN(U)) v || (this.drawSmoothedGraph(w, t, O, P), w = [], t = [], O = [], P = []);
                            ...
                            if (Math.abs(D -
                                    fb) >= hb || Math.abs(C - gb) >= hb) w.push(D), t.push(C), fb = D, gb = C;
                            aa = D;
                            ia = C;
                            ea = D;
                            fa = C;
                                ...
                                if (q) {
                                    ...
                                    if (S < m + V * I && 0 < Q)
                                        if (ra = new AmCharts.Cuboid(e, Q, da, I - a.d3x, F - a.d3y, Ca,
                                                Wa, X, pa, this.lineAlpha, G, s, q, R, Xa), 0 > U && "middle" != L && "inside" != L) L = "bottom";
